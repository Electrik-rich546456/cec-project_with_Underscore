...
#---------------------------My edits-------------
    if u'0f:86:10:00' in message:
        global ganted
        ganted =  True
        print(' tuned back')
        os.system("xdg-screensaver resume 0x600010")
    if u'0f:86:30:00' in message:
#        global ganted
        ganted = False
        print(' tuned away')
        os.system("xdg-screensaver suspend 0x600010")
#-------------------------------------------------  
...
def dunno():
    ...
    while ganted: 
        ...
        if output == "off":
            print("it worked")
            pyCecClass.ProcessCommandStandby(0)
            ganted = False
            break
        if output == "on":
            pyCecClass.ProcessCommandpoweron(0)
            ganted = False
            break
            
#        else:
#            pyCecClient.ProcessCommandpoweron()
#            
#        if output == "on":
#            self.ProcessCommandpoweron()
#        if output == "off":
